...
public interface IDWFApi {
    ...
    void createWccDoc(Context context, String title, String description, String body, String country, String url, String uid, final CreateWccDocumentCallback callback);
